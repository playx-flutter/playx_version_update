...
sealed class PlayxVersionUpdateResult<T> {
  ...
  PlayxVersionUpdateResult<S> map<S>({
    ...
    required PlayxVersionUpdateResult<S> Function(PlayxVersionUpdateError error) error,
  }) =>
      switch (this) {
        PlayxVersionUpdateSuccessResult<T> result => success(result.data),
        PlayxVersionUpdateErrorResult<T> result => error(result.error),
  ...
  Future<PlayxVersionUpdateResult<S>> mapAsync<S>({
    ...
    required Future<PlayxVersionUpdateResult<S>> Function(PlayxVersionUpdateError error) error,
  }) async =>
      switch (this) {
...
class PlayxVersionUpdateSuccessResult<T> extends PlayxVersionUpdateResult<T> {
  ...
  PlayxVersionUpdateSuccessResult<T> copyWith({T? data}) => PlayxVersionUpdateSuccessResult(data ?? this.data);
}
...
class PlayxVersionUpdateErrorResult<T> extends PlayxVersionUpdateResult<T> {
  ...
  PlayxVersionUpdateErrorResult<T> copyWith({PlayxVersionUpdateError? error}) => PlayxVersionUpdateErrorResult(error ?? this.error);
}