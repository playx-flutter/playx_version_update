...
const String _installDownloadNotPresentErrorCode =
...
const String _installPlayStoreNotFoundErrorCode =
    'INSTALL_PLAY_STORE_NOT_FOUND';
...
///
/// This class wraps a [network.NetworkException] from the `playx_network` package,
/// providing a unified error type within the `PlayxVersionUpdateError` hierarchy.
class PlayxVersionNetworkError extends PlayxVersionUpdateError {
  final network.NetworkException error;

  const PlayxVersionNetworkError(this.error);

  @override
  String get message => error.message;

  @override
  String get errorCode => error is network.ApiException
      ? (error as network.ApiException).statusCode.toString()
      : error.errorMessage;
}
...
sealed class PlayxInstallError extends PlayxVersionUpdateError {
  ...
  factory PlayxInstallError.fromKotlinErrorCode(
      String errorCode, String errorMessage) {
    switch (errorCode) {
      case _installApiNotAvailableErrorCode:
        return const InstallApiNotAvailableError();
      case _installAppNotOwnedErrorCode:
        return const InstallAppNotOwnedError();
      case _installDownloadNotPresentErrorCode:
        return const InstallDownloadNotPresentError();
      case _installInProgressErrorCode:
        return const InstallInProgressError();
      case _installNotAllowedErrorCode:
        return const InstallNotAllowedError();
      case _installUnavailableErrorCode:
        return const InstallUnavailableError();
      case _installInternalErrorCode:
        return const InstallInternalError();
      case _installInvalidRequestErrorCode:
        return const InstallInvalidRequestError();
      case _installPlayStoreNotFoundErrorCode:
        return const InstallPlayStoreNotFoundError();
      case _installUnknownErrorCode:
        return InstallUnknownError(
            errorCode: _installUnknownErrorCode, errorMessage: errorMessage);
      default:
        return InstallUnknownError(
...
class InstallApiNotAvailableError extends PlayxInstallError {
  const InstallApiNotAvailableError()
      : super._(_installApiNotAvailableErrorCode,
...
class InstallAppNotOwnedError extends PlayxInstallError {
  const InstallAppNotOwnedError()
      : super._(_installAppNotOwnedErrorCode,
...
class InstallDownloadNotPresentError extends PlayxInstallError {
  const InstallDownloadNotPresentError()
      : super._(_installDownloadNotPresentErrorCode,
...
class InstallInProgressError extends PlayxInstallError {
  const InstallInProgressError()
      : super._(_installInProgressErrorCode,
...
class InstallNotAllowedError extends PlayxInstallError {
  const InstallNotAllowedError()
      : super._(
            _installNotAllowedErrorCode,
...
class InstallUnavailableError extends PlayxInstallError {
  const InstallUnavailableError()
      : super._(_installUnavailableErrorCode,
...
class InstallInternalError extends PlayxInstallError {
  const InstallInternalError()
      : super._(_installInternalErrorCode,
...
class InstallInvalidRequestError extends PlayxInstallError {
  const InstallInvalidRequestError()
      : super._(_installInvalidRequestErrorCode,
...
class InstallPlayStoreNotFoundError extends PlayxInstallError {
  const InstallPlayStoreNotFoundError()
      : super._(_installPlayStoreNotFoundErrorCode,
...
class InstallUnknownError extends PlayxInstallError {
  const InstallUnknownError(
      {required String errorCode, required String errorMessage})
...
class PlatformNotSupportedError extends PlayxVersionUpdateError {
  @override
  String get message =>
      "This platform does not support in-app updates. Please check for updates through your device's app store.";
...
class AppUpdateMangerNotFoundError extends PlayxVersionUpdateError {
  @override
  String get message =>
      "The in-app update service is not available on this device. Ensure Google Play Services are up to date.";
...
class NotSupportedException extends PlayxVersionUpdateError {
  ...
  @override
  String get message =>
      'The requested operation is not supported. Please ensure your app is up to date.';
...
class VersionFormatException extends PlayxVersionUpdateError {
  ...
  @override
  String get message =>
      "The version information received could not be understood. Please try again later.";
